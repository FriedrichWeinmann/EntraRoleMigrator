...
Remove-Module EntraRoleMigrator -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\EntraRoleMigrator\EntraRoleMigrator.psd1"
Import-Module "$PSScriptRoot\..\EntraRoleMigrator\EntraRoleMigrator.psm1" -Force
