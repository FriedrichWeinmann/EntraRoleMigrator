...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\EntraRoleMigrator\functions", "$global:testroot\..\EntraRoleMigrator\internal\functions"),
	
	[string]
	$ModuleName = "EntraRoleMigrator",
...
$CommandPath = @(
    "$global:testroot\..\EntraRoleMigrator\functions"
    "$global:testroot\..\EntraRoleMigrator\internal\functions"
)
